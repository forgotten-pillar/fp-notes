...
| ---------------------------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| One God                                  | The Father                                                                   | A unity of three persons - God the Father, God the Son, God the Holy Spirit                                                                                                                                       |
| The personality[^def] of God             | A personal Spiritual Being                                                   | As of God as a unity of three persons, it is not *not explained*. As of the Father, it is the same as of God the Holy Spirit, and of God the Son. (see the personality of the Holy Spirit below)                  |
...
| The personality[^def] of Chirst          | Implied by the phrase: "*the Son of the Eternal Father*"                     | God the Son - incarnated as Jesus Christ                                                                                                                                                                          |
| The personality[^def] of the Holy Spirit | Implied by the phrase: "*the representative*" - it cannot be 'impersonal'    | "*He is as much a person as are the Father and the Son*" - equal in personality as the Father and the Son: "***The qualities** and powers exhibited in the Son and the Holy Spirit are also those of the Father*" |
| God as a being?                          | One - the Father                                                             | unknown, could be three or only one, but not two, since all Three are co-equal\*\* in the personality[^def]                                                                                                       |
...
[^def]: the personality - "*the quality or state of being a person*" [Merriam Webster](https://www.merriam-webster.com/dictionary/personality), in other words by what characteristics we can determine someone to be a person?

\*\* equal in personality - check out [[three-co-equal|Three Co-equal Persons]] article for more details
